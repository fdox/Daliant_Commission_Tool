...
/// Sign-up choice screen (Wix-style).
...
struct SignUpChoiceView: View {
    ...
    var body: some View {
        GeometryReader { proxy in
            VStack(spacing: 0) {
                ...
                VStack(spacing: DS.Spacing.xs) {
                    Text("Create an Account")
                        .font(DS.Font.title)
                    Text("Create a Daliant account to continue")
                        .font(DS.Font.sub)
                ...
                VStack(spacing: DS.Spacing.md) {
                    GoogleContinueButtonSU(title: "Continue with Google") { onGoogle?() }
                    AppleContinueButtonSU { onApple?() } // logo left + centered title
                }
                .padding(.horizontal, DS.Spacing.xl)
            ...
            // Footer pinned to the safe-area bottom (kept on Sign-Up/Sign-In screens)
...
/// Google-style button with centered title and a left Google glyph (colored)
private struct GoogleContinueButtonSU: View {
    ...
    private struct GoogleGlyphSU: View {
        var body: some View {
            ZStack {
...
/// Apple-style button with centered title and a left Apple logo (white on black)
private struct AppleContinueButtonSU: View {
    var action: () -> Void
...
/// Generic outlined button with a leading SF Symbol and a centered title (for "Sign up with Email")
private struct OutlinedLeadingIconButtonSU: View {
    var title: String
...
#if DEBUG
struct SignUpChoiceView_Previews: PreviewProvider {
